...
## Panel Admina
 posiadał dodatkową funkcję transakcje, z której zrezygnowaliśmy, uznaliśmy, że nie jest jednak potrzebna w naszym projekcie, więc w kodzie się znajduje, ale jest nie widoczna na stronie